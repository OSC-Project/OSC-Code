...
const types = ['sqli', 'cmdi', 'jsi', 'js_function', 'js_extra',''];
// {
// 	type : 'sqli', the type of injection
// 	sinks: ['query'], the exploitable function call
// 	pattern: ['createConnection', 'mysql'] the library or function_call/library that contains the function call
// }
injections = [
		{
			type : 'sqli',
