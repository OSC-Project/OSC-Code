...
bigram_terms = ['arbitrari command', 'command inject', 'inject vulner', 'a command', 'for node', 'inject in', 'execut arbitrari', 'to execut', 'sequel is', 'sqlite and', 'and microsoft', 'microsoft sql', 'sql servrer', 'arbitrari code']
...
for vuln in relevant_cves:
    ...
    for term in s:
        data[term] = 0
        if term[0] + " " + term[1] in bigram_terms:
